 ...
 * 
 * 
 * @version 1.0 DAO class for Reporting
 */
...
public interface IReportingDAO {
	 ...
	 * @throws Exception
	 */
	public DRSDTO getDailyRemittance(String drNo, Date date) throws Exception;
	...
	public InwardAnalysisDTO[] getInwardAnalysis(Date fromDate, Date toDate,
			String fromStn, String inwardStn, String dbHistory) throws RemoteException, Exception;
	 ...
	 * @throws Exception
	 */
	public int getLRTrackCount(Date date,Date to_date, String dbHistory) throws RemoteException, Exception;
	...
	public DRSDTO manipulateDRSDetailsHistory(String stationCode, Date date, String dbHistory) throws Exception;
	...
	*/
	 ...
	 * @throws Exception
	 */
	public DRSDTO manipulateDRSDetails(String stationCode, Date date)
			throws Exception;
	...
	public GMRReportDTO[] getGoodsMovementList(String stationCode, Date date,String DBHistory)
			throws Exception;
	...
	public GMRReportDTO[] getGoodsMovementListHistory(String stationCode, Date date,String DBHistory)
	throws Exception;
	...
	/*public CurrentStatusDTO[] getCurrentStatusHistory(String code)
	throws RemoteException, Exception;
	...
	*/
	...
	public DeliveryVerificationDTO[] getVerificationReportHistory(String[] details,String DBHistory)
	throws RemoteException, SQLException, Exception;
	...
	*/
	...
	public DDRDTO[] getDDReportHistory(Date from, Date to, String station,String DBHistory)
	throws Exception;
	...
	public BookingDTO[] getCancelledLRHistory(Date fromDate, Date toDate, String type,String branch_code,String station_code,String DBHistory)
	...
	public GeneralSummaryDTO[] getTotalUnDeliveredTopayHistory(Date fromDate, Date toDate,
			String branch,String DBHistory) throws RemoteException, BusinessException, Exception;
	...
	public GeneralSummaryDTO[] getDailyBookingAnalysisHistory(Date fromDate, Date toDate,String DBHistory)
	throws RemoteException, BusinessException, Exception;
	...
	public StationsDTO[] getCounterConsolidatedHistory(Date fromDate, Date toDate,
			String station_code, StationsDTO[] stations,String DBHistory)
			throws RemoteException, BusinessException, Exception;
	...
	public StationsDTO[] getCounterConsolidatedMiscHistory(Date fromDate, Date toDate,
			String station_code, StationsDTO[] stations,String DBHistory)
			throws RemoteException, BusinessException, Exception;
	...
	public BookingDTO[] getUPDReady(String station_code, String branch_code,
			int inwardDays, boolean isMoreThan,String DBHistory) throws RemoteException, Exception;
	 ...
	 * @throws Exception
	 */
	public DRSAttendanceDTO[] getDRSAttendance(int type,String station_code, int month, int year,String dbHis)
			throws RemoteException, BusinessException, Exception;
	...
	public StationsDTO[] getServicetax(Date fromDt, Date toDate,String DBHistory)throws  Exception;
	
	public StationsDTO[] getServicetaxHistory(Date fromDt, Date toDate,String DBHistory)throws  Exception;
	
	public StationsDTO[] getServicetaxLR(Date fromDt, Date toDate,String DBHistory)throws  Exception;
	
	public StationsDTO[] getServicetaxLRHistory(Date fromDt, Date toDate,String DBHistory)throws  Exception;
	...
	public BookingDTO[] getFOCLRSUnion(Date from_date, Date to_date,
			String branch_code, int type, String history)throws  Exception;

	public BookingDTO[] getOpenLRSUnion(Date fromDate, Date toDate,
			String branchCode, String history)throws  Exception;

	public CustomerBusinessAnalysisDTO[] getInterIntraStateUnion(Date fromDate,
			Date toDate, String history)throws  Exception;

	public GMROutTimeDTO[] getInwardRegisterUnion(Date from, Date to,
			String branchCode, String stnCode, String history)throws  Exception;

	public GeneralSummaryDTO[] getSundryBookingAnalysisUnion(Date fromDate,
			Date toDate, String branch, String station, String history)throws  Exception;
	...
	public BookingDTO[] getTotalUnDeliveredTopayDetailedUnion(
			String branch_code, Date fromDate, Date toDate, String history)throws  Exception;

	public GeneralSummaryDTO[] getTotalUnDeliveredTopayUnion(Date fromDate,
			Date toDate, String branch, String history)throws  Exception;
	...
	public BookingDTO[] getCancelledLRUnion(Date fromDate, Date toDate,
			String type, String branch_code, String station_code, String history)throws  Exception;

	public RemittanceShortageDTO[] getRSReportUnion(String branch, int month,
			int year, String history)throws  Exception;
	...
	public BookedLRDTO[] getBookedLRsUnion(Date fromDate, Date toDate,
			String branchCode, String dbHistory)throws  Exception;
