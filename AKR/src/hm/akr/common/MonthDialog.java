		...
		for (int i = 0; i < 12; i++) {
			...
			lblMonths[i].addMouseListener(new MouseListener() {
				...
				public void mouseDoubleClick(MouseEvent event) {
					...
					String fromDate = "04-2011";	
					String serverDt = beanutil.getServerDate(); 
					String toDate =  serverDt;
					toDate = toDate.substring(toDate.indexOf("-")+1);
					
					String currentMonth = toDate;
					
					if(BeanUtil.getDbName().equalsIgnoreCase("powerakr_2009-10")){
						fromDate = "03-2009";
						toDate = "03-2010";
					}else if(BeanUtil.getDbName().equalsIgnoreCase("powerakr_2010-11")){
						fromDate = "04-2010";
						toDate = "03-2011";
					}		
					...
					try {
						...
						if(source == 22){
							...
							to = frmt.parse(serverDt);
							//System.out.println("to11111==>"+ to);
							to.setMonth(to.getMonth() -1);
							//System.out.println("to222==>"+ to);
							prevMonth = frmt.format(to);
							//System.out.println("String prevMon-->"+ prevMonth);
