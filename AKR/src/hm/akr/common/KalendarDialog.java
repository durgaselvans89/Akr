	...
	public void mouseDoubleClick(MouseEvent e) {
		...
		if (!day.getText().equals("")) {
			...
			try{
				...
				String fromDate = "1-04-2011";
				String toDate =  beanutil.getServerDate();
				
				//System.out.println("dbname"+BeanUtil.getDbName());
				if(BeanUtil.getDbName().equalsIgnoreCase("powerakr_2009-10")){
				//if(BeanUtil.getDbName().equalsIgnoreCase("powerakr_2010")){
					fromDate = "1-03-2009";
					toDate = "31-03-2010";
