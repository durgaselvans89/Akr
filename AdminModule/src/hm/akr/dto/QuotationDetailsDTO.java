...
public class QuotationDetailsDTO implements Serializable
{
	...
	/**
	 * @return the ddchargeValue
	 */
	public float getDdchargeValue() {
		return ddchargeValue;
	}

	/**
	 * @param ddchargeValue the ddchargeValue to set
	 */
	public void setDdchargeValue(float ddchargeValue) {
		this.ddchargeValue = ddchargeValue;
	}
