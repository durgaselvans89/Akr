...
public class QuotationDTO implements Serializable{
	...
	private int roundOffDigits = 0;
	
	private int is_Approved = 0;
	
	private DhcDto[] dhcDto = null;
	
	private byte dhcChargeType = 0;
	 ...
	 */
	public int getRoundOffDigits() {
		return roundOffDigits;
	}

	/**
	 * @param roundOffDigits the roundOffDigits to set
	 */
	public void setRoundOffDigits(int roundOffDigits) {
		this.roundOffDigits = roundOffDigits;
	}
	...
	public DhcDto[] getDhcDto() {
		return dhcDto;
	}

	public void setDhcDto(DhcDto[] dhcDto) {
		this.dhcDto = dhcDto;
	}

	/**
	 * @return the dhcChargeType
	 */
	public byte getDhcChargeType() {
		return dhcChargeType;
	}

	/**
	 * @param dhcChargeType the dhcChargeType to set
	 */
	public void setDhcChargeType(byte dhcChargeType) {
		this.dhcChargeType = dhcChargeType;
	}
