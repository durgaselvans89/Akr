 ...
 * 
 */
public class QuotationDetailsComposite extends Composite implements IQuotationConstants, IUIConstants, FocusListener {
	 ...
	 * @param quotDTO
	 */
	public QuotationDetailsComposite(Composite parent, int style, int selectionIndex, QuotationDTO quotationDto) {
		super(parent, style);
		this.parent = parent;
