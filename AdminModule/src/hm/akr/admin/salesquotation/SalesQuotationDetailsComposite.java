...
import hm.akr.admin.quotation.DhcPop;
 ...
 * 
 */
public class SalesQuotationDetailsComposite extends Composite implements SalesIQuotationConstants, IUIConstants, FocusListener {
	 ...
	 * @param quotDTO
	 */
	public SalesQuotationDetailsComposite(Composite parent, int style, int selectionIndex, QuotationDTO quotationDto) {
		super(parent, style);
		this.parent = parent;
	...
	private QuotationDetailsDTO[] getQuotationDetailsForMixedArticle() {
		...
		if (quotationDTO != null && quotationDTO.getQuotationDetails() != null) {
			...
			details = new QuotationDetailsDTO[tblLen];
		...
		{
			{
				...
				lblBookingType.setBounds(20, 14, 83, 15);
...

			{
				...
				lblPriceIndex.setBounds(184, 14, 61, 17);
...

			{
				...
				lblMinCW.setBounds(348, 14, 114, 16);
...

			{
				...
				lblMinCF.setBounds(516, 14, 110, 16);
...

			{
				...
				cbBookingType.setBounds(20, 34, 120, 21);
...

			{
				...
				txtPriceIndex.setBounds(184, 34, 120, 21);			
...

			{
				...
				txtMinCW.setBounds(348, 34, 120, 21);
				...
				txtMinCW.addKeyListener(new KeyListener() {
					...
					public void keyPressed(KeyEvent arg0) {
						if (txtMinCW.getMessage().equals("DC")) {
			...
			}
			{
				...
				txtMinCF.setBounds(516, 34, 100, 21);
			...
			}
			{
				...
				lblInsurance.setBounds(348, 80, 112, 19);
			...
			//
			{
				...
				btnLRCPop.setBounds(122, 99, 20, 21);
			...
			}
			{
				...
				btnGSCPop.setBounds(286, 99, 20, 21);
			...
			}
			{
				...
				cbInsurance.setBounds(348, 99, 120, 21);
				...
				btnInsurancePop.setBounds(470, 100, 20, 21);
			...
			//DHC
			{
				...
				btnDHCPop.setBounds(618, 99, 20, 21);
			...
			//ST
			{
				...
				chkServiceTax.setBounds(655, 103, 14, 13);
			}
			
			{
				lblST = new Label(this, SWT.NONE);
				lblST.setText("Service Tax");
				lblST.setBounds(674, 103, 84, 20);
				lblST.setForeground(QUOTATION_COLOR);
			}
			
			Group articleGroup = new Group(this, SWT.NONE);
			articleGroup.setText("");
			articleGroup.setBounds(13, 136, 640, 160);
			articleGroup.setLayout(this.getLayout());
			
			{
				{
					lblArtilcleName = new Label(articleGroup, SWT.NONE);
					lblArtilcleName.setText("ArticleName");
					lblArtilcleName.setBounds(10, 19, 60, 18);
					lblArtilcleName.setForeground(QUOTATION_COLOR);
				}
				
				{
					txtArticleName = new Text(articleGroup, SWT.BORDER);
					txtArticleName.setBounds(10, 39, 120, 21);
			...
			{
				{
					lblCW = new Label(articleGroup, SWT.NONE);
					lblCW.setText("ChargedWeight");
					lblCW.setBounds(171, 19, 91, 18);
					lblCW.setForeground(QUOTATION_COLOR);
				}

				{
					txtCW = new Text(articleGroup, SWT.BORDER);
					txtCW.setBounds(171, 39, 120, 21);
			...
			{
				cccGroup = new Group(articleGroup, SWT.NONE);
				cccGroup.setText("CCC");
				cccGroup.setBounds(5, 74, 126, 80);
				
				{
					cbCCC = new Combo(cccGroup, SWT.READ_ONLY);
					cbCCC.setBounds(6, 18, 106, 21);
					cbCCC.add(optionB[0]);
					cbCCC.add(optionB[1]);
					cbCCC.add(optionB[2]);
					cbCCC.add(optionB[3]);
					...
					txtCCCValue.setBounds(6, 48, 106, 21);
			...
			{
				dccGroup = new Group(articleGroup, SWT.NONE);
				dccGroup.setText("DCC");
				dccGroup.setBounds(169, 74, 126, 80);
				
				{
					cbDCC = new Combo(dccGroup, SWT.READ_ONLY);
					cbDCC.setBounds(6, 18, 106, 21);
					cbDCC.add(optionB[0]);
					cbDCC.add(optionB[1]);
					cbDCC.add(optionB[2]);
					cbDCC.add(optionB[3]);
					...
					txtDCCValue.setBounds(6, 48, 106, 21);
			...
			{
				iecGroup = new Group(articleGroup, SWT.NONE);
				iecGroup.setText("IEC");
				iecGroup.setBounds(334, 20, 129, 80);
				{
					cbIEC = new Combo(iecGroup, SWT.READ_ONLY);
					cbIEC.setBounds(6, 18, 106, 21);
					cbIEC.add(optionB[0]);
					cbIEC.add(optionB[1]);
					cbIEC.add(optionB[3]);
					//cbIEC.select(1);
					...
					txtIEC_article.setBounds(6, 48, 106, 21);
			...
			{
				loadingchargeGroup = new Group(articleGroup, SWT.NONE);

				loadingchargeGroup.setText("Loading Charge");
				loadingchargeGroup.setBounds(503, 20, 126, 80);
				{
					cbLoadingCharge = new Combo(loadingchargeGroup, SWT.READ_ONLY);
					cbLoadingCharge.setBounds(6, 18, 106, 21);
					...
					txtLC_article.setBounds(6, 48, 106, 21);
			...
			{
				ddcGroup = new Group(articleGroup, SWT.NONE);
				ddcGroup.setText("DDC");
				ddcGroup.setBounds(334, 107, 297, 47);
				...
				}
				{
					...
					lblchargeArticle.setBounds(170, 20, 70, 21);
					...
					txtDDC_chargeArticle.setBounds(242, 18, 50, 21);
			...
			}
			{
				...
				btnAdd.setText("Add");
				btnAdd.setBounds(659, 270, 50, 25);
				btnAdd.addSelectionListener(new QuotationAction());
			}
			

			cptTableLRC = new Composite(this, SWT.NONE);
			cptTableLRC.setBounds(13, 315, 737, 131);

			{
				gpArticleTable = new Group(cptTableLRC, SWT.NONE);
				gpArticleTable.setText("Articles");
				gpArticleTable.setBounds(0, -3, 730, 126);

				{

					tblArticle = new Table(gpArticleTable, SWT.H_SCROLL | SWT.FULL_SELECTION | SWT.V_SCROLL
							| SWT.BORDER | SWT.MULTI);
					tblArticle.setHeaderVisible(true);
					tblArticle.setLinesVisible(true);
					tblArticle.setBounds(6, 20, 715, 95);
			...
			changeType(findTypeName((byte) selectionIndex));
	...
	public boolean validateQuotationValues() {		
		...
		if(cbBookingType.getText().equals(EMPTYSTRING)){
			AdminComposite.display("Please select booking type", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;
			...
			return false;
		}else if(cbLRC.getText().equals(EMPTYSTRING)){
			AdminComposite.display("Please Select LRC", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;
		}else if(cbGSC.getText().equals(EMPTYSTRING)){
			AdminComposite.display("Please Select GSC", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;
		}else if(cbDHC.getText().equals(EMPTYSTRING)){
			AdminComposite.display("Please Select DHC", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;
		}else if(cbInsurance.getText().equals(EMPTYSTRING)){
			AdminComposite.display("Please Select Insurance", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;
		}else if(btnLRCPop.isEnabled() && lrcDTO == null && quotationDTO == null){
			AdminComposite.display("Please provide LRC Charges", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;			
		}else if(btnGSCPop.isEnabled() && gscDTO == null && quotationDTO == null){
			AdminComposite.display("Please provide GSC Charges", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;			
		}else if( quotationDTO != null && (btnLRCPop.isEnabled() || btnGSCPop.isEnabled()) && (quotationDTO.getOtherCharges() == null && lrcDTO == null && gscDTO == null)){
			AdminComposite.display("Please provide LRC/GSC Charges", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;			
		}else if(btnInsurancePop.isEnabled() && insuranceDTO == null && quotationDTO == null){
			AdminComposite.display("Please provide Insurance Charges", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;			
		}else if(quotationDTO != null && btnInsurancePop.isEnabled() && quotationDTO.getInsuranceCharges() == null && quotationDTO == null){
			AdminComposite.display("Please Provide Insurance Charges", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
			return false;			
		}else if(btnDHCPop.isEnabled() &&  quotationDTO == null && dhcDto == null ){
			...
			// Weight/Article
			if(!tblArticle.isVisible() && txtArticleName.isEnabled()  && txtArticleName.getText().equals(EMPTYSTRING)){
				AdminComposite.display("Please Enter Article Name", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
				return false;			
			}else if(!tblArticle.isVisible() && txtCW.isEnabled()  && txtCW.getText().equals(EMPTYSTRING)){
				AdminComposite.display("Please Enter Charged Weight", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
				return false;			
			}else if(cbCCC.getText().equals(EMPTYSTRING)){
				AdminComposite.display("Please Select CCC", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
				return false;
			}else if(cbDCC.getText().equals(EMPTYSTRING)){
				AdminComposite.display("Please Select DCC", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
				return false;
			}else if(cbIEC.getText().equals(EMPTYSTRING)){
				AdminComposite.display("Please Select IEC", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
				return false;
			}else if(cbLoadingCharge.getText().equals(EMPTYSTRING)){
				AdminComposite.display("Please Select Loading Charges", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
				return false;
			}else if(cbDDC.getText().equals(EMPTYSTRING)){
				AdminComposite.display("Please Select DDC", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
				return false;
			}
		}
	...
	public class QuotationAction implements SelectionListener {
		...
		private boolean isValidArticle() {
			if(txtArticleName.isEnabled()  && txtArticleName.getText().equals(EMPTYSTRING)){
				AdminComposite.display("Please Enter Article Name", STATUS_SUCCESS, SUCCESS_FONT_COLOR);
				return false;			
	...
	private void handleLRCPop() {
		...
		try {
			...
			SalesOtherChargesPop ocPop = new SalesOtherChargesPop(shell, SWT.BORDER, true);
	...
	private void handleDHCPop() {
		...
		try {
			...
			//System.out.println("from DHC popup==>"+dhcDto);
	...
	private void handleMixedArticleDropdown(){
		...
		if(gpArticleTable.isVisible() && tblArticle.getItemCount() > 0){
