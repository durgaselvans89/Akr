 ...
 * 
 */
public class SalesManualEditComposite extends Composite implements SalesIQuotationConstants, IUIConstants, FocusListener {
	 ...
	 * @param quotDTO
	 */
	public SalesManualEditComposite(Composite parent, int style, int selectionIndex, QuotationDTO quotationDto,
	...
	public boolean validateQuotationValues() {
		...
		if (customer < 0) {
			...
			return false;
		} else if (quotationDTO != null && btnInsurancePop.isEnabled() && quotationDTO.getInsuranceCharges() == null
				&& quotationDTO == null) {
