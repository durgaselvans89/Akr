...
public class SalesQuotationFinishComposite extends Composite {
	 ...
	 * @throws Exception
	 */
	public SalesQuotationFinishComposite(Composite composite, int swtValue, QuotationDTO quotationDTO) throws Exception {
