 ...
 */
public class SalesQuotationComposite extends Composite implements SelectionListener,
	...
	private SalesQuotationDetailsComposite composite = null;
	 ...
	 * @param style
	 */
	public SalesQuotationComposite(Composite parent, int style) {
		super(parent, style);
		try {
	...
	public Composite loadComposite() throws Exception{
		...
		{
			composite = new SalesQuotationDetailsComposite(this, SWT.BORDER, 0,quotationDTO); //0 - Weight Based
	...
	private void handlePreviousAction() {
		...
		//Load composite		
		composite = new SalesQuotationDetailsComposite(this, SWT.BORDER, index, quotationDTO); //0 - Weight Based
		composite.loadComposite();
		composite.setBounds(15, 60, 750, 470);
